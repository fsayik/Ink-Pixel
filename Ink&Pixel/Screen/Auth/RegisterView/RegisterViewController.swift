...
class RegisterViewController: UIViewController {
    ...
    private let forgotPasswordButton: UIButton = {
        let button = UIButton(type: .system)
        button.setTitle("Term and Conditions", for: .normal)
    ...
    init(coordinator: CoordinatorProtocol,
        viewModel: RegisterViewModelProtocol) {
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            signUpButton.topAnchor.constraint(equalTo: forgotPasswordButton.bottomAnchor, constant: 24),
...
// MARK: - RegisterViewModelOuputProtocol
extension RegisterViewController: RegisterViewModelOuputProtocol {
